...
data class GenerateWorkoutRequestDto(
    val profile: com.nexal.app.domain.model.UserProfile,
    val previousLogs: List<com.nexal.app.domain.model.WorkoutLog>? = null,
...
data class MealSubstituteRequestDto(
    ...
    val foodName: String,
    val reason: String,
    val currentMacros: com.nexal.app.domain.model.MacroNutrients
)
...
data class AssessWorkoutRequestDto(
    ...
    val logs: List<com.nexal.app.domain.model.WorkoutLog>
)
...
data class AssessFoodRequestDto(
    ...
    val macros: com.nexal.app.domain.model.MacroNutrients,
    val ratio: Double
)
...
data class SyncWorkoutPlansDto(
    val plans: List<com.nexal.app.domain.model.WorkoutPlan>
)
...
data class SyncCustomWorkoutLogsDto(
    val logs: List<com.nexal.app.domain.model.CustomWorkoutLog>
)

@Serializable
data class SyncMealPlansDto(
    val plans: List<com.nexal.app.domain.model.MealPlan>
)

@Serializable
data class SyncFoodLogsDto(
    val entries: List<com.nexal.app.domain.model.FoodLogEntry>
)

@Serializable
data class SyncWeightEntriesDto(
    val entries: List<com.nexal.app.domain.model.WeightEntry>
)

@Serializable
data class SyncWaterLogsDto(
    val entries: List<com.nexal.app.domain.model.WaterLogEntry>
)

@Serializable
data class SyncCardioLogsDto(
    val entries: List<com.nexal.app.domain.model.CardioLogEntry>
)
